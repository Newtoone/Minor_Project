...
const AutoHeightTextarea = ({ value, onChange, placeholder }) => {
  ...
  return (
    <textarea
      ...
      className="w-full bg-gray-800 text-white p-2 rounded resize-none overflow-hidden"
      style={{ height: 'auto' }}
    />
  );
};
...
const Template = () => {
  ...
  return (
    <>
    <div className="text-white w-screen grid grid-cols-3 gap-4 p-4">
      {/* HTML Section */}
      <div className="bg-gray-900 flex flex-col p-4 rounded">
        <div className="flex items-center justify-between mb-2">
          <p>HTML</p>
          <button onClick={downloadHTML} className="btn bg-blue-500 text-white px-2 py-1 rounded">
            Download HTML
          </button>
        </div>
        <AutoHeightTextarea
      ...
      <div className="bg-gray-900 flex flex-col p-4 rounded">
        <div className="flex items-center justify-between mb-2">
          <p>CSS</p>
          <button onClick={downloadCSS} className="btn bg-blue-500 text-white px-2 py-1 rounded">
            Download CSS
          </button>
        </div>
        <AutoHeightTextarea
      ...
      <div className="bg-gray-900 flex flex-col p-4 rounded">
        <div className="flex items-center justify-between mb-2">
          <p>JavaScript</p>
          <button onClick={downloadJS} className="btn bg-blue-500 text-white px-2 py-1 rounded">
            Download JS
          </button>
        </div>
        <AutoHeightTextarea
    ...
    <div className="p-4">
      ...
      <div className="mt-4 grid grid-cols-3 gap-4">
        <div>
          <h3 className="text-white">HTML Preview</h3>
          <AutoHeightTextarea value={html} onChange={() => {}} placeholder="" />
        </div>
        <div>
          <h3 className="text-white">CSS Preview</h3>
          <AutoHeightTextarea value={css} onChange={() => {}} placeholder="" />
        </div>
        <div>
          <h3 className="text-white">JavaScript Preview</h3>
